...
namespace InventoryManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20231025003056_restructure tables")]
    partial class restructuretables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManagementSystem.Domain.Entities.ReceivedProduct", b =>
                {
                    b.HasOne("InventoryManagementSystem.Domain.Entities.Product", "Product")
                        .WithOne("ReceivedProduct")
                        .HasForeignKey("InventoryManagementSystem.Domain.Entities.ReceivedProduct", "ProductCode")
            ...
            modelBuilder.Entity("InventoryManagementSystem.Domain.Entities.Sale", b =>
                {
                    b.HasOne("InventoryManagementSystem.Domain.Entities.Product", "Product")
                        .WithOne("Sale")
                        .HasForeignKey("InventoryManagementSystem.Domain.Entities.Sale", "ProductCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
